...
const Checkout = () => {
  ...
  const steps = ['Shipping Information', 'Payment Method', 'Order Summary', 'Review & Confirm'];
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-white border border-orange-200 shadow-lg rounded-xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-100 border-b border-orange-200">
                <CardTitle className="text-orange-800 flex items-center">
                  <span className="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2">1</span>
          ...
          {currentStep === 2 && (
            <Card className="bg-white border border-orange-200 shadow-lg rounded-xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-100 border-b border-orange-200">
                <CardTitle className="text-orange-800 flex items-center">
                  <span className="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2">2</span>
                  Payment Method
                </CardTitle>
              </CardHeader>
          ...
          {currentStep === 3 && (
            <Card className="bg-white border border-orange-200 shadow-lg rounded-xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-orange-100 border-b border-orange-200">
                <CardTitle className="text-orange-800 flex items-center">
                  <span className="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2">3</span>
                  Order Summary
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6">
