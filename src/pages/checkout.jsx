...
const Checkout = () => {
  ...
  const handleApplyVoucher = () => {
    ...
    if (VOUCHERS[code]) {
      setDiscount(VOUCHERS[code]);
      setVoucherStatus(`Voucher applied: ${code} (${VOUCHERS[code] * 100}% off)`);
    } else {
      setDiscount(0);
      setVoucherStatus('Invalid voucher code');
    }
  };
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="mb-6">
            <h2 className="text-lg font-bold mb-2">Have a voucher or coupon?</h2>
            <div className="flex items-center gap-2">
              <Input
                ...
                className="w-48"
              />
              <Button type="button" onClick={handleApplyVoucher} data-testid="apply-voucher">Apply</Button>
            </div>
            {voucherStatus && (
              <div className={`mt-2 text-sm ${discount > 0 ? 'text-green-600' : 'text-red-600'}`}>{voucherStatus}</div>
            )}
          </div>
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 space-y-6">
            ...
            <div className="flex space-x-4">
              <Button 
                ...
                className="w-full bg-amazon-orange hover:bg-orange-600 text-gray-800"
        ...
        <div className="lg:col-span-1">
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 sticky top-6">
            ...
            {discount > 0 && (
              <div className="mb-2 text-green-600 font-semibold">Voucher applied: {Math.round(discount * 100)}% off</div>
            )}
            ...
            <div className="space-y-3 mb-4">
              ...
              {discount > 0 && (
                <div className="flex justify-between text-green-600">
                  ...
                  <span>-{formatPrice(getCartGrandTotal() * discount)}</span>
                </div>
              )}
              <Separator />
              <div className="flex justify-between text-lg font-bold">
                <span>Order total:</span>
                <span className="text-primary">{formatPrice(getCartGrandTotal() * (1 - discount))}</span>
              </div>
            </div>
